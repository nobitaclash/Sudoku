...
public class AndroidUtils {
	...
	/**
	 * Setup Ad Metwork Has to be called when the activity starts (onCreate())
	 * but after the layout has been set (setContentView())
	 * 
	 * @param activity
	 */
	...
	public static void setBackGroundActionBar(Context context,
			ActionBar actionBar) {
		if (actionBar == null)
			return;
